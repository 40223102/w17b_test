...
class Midterm(object):
    ...
    @cherrypy.expose
    # N 為齒數, M 為模數, P 為壓力角
    def spur_1(self, N=15, N1=24,N2=15, N3=24,M=10, P=20):
        outstring = '''
    <!DOCTYPE html> 
    <html>
    <head>
    ...
    <form method=POST action=spuraction_1>
    ...
    模數  :<input type=text name=M value='''+str(M)+'''><br />
    壓力角:<input type=text name=P value = '''+str(P)+'''><br />
    <input type=submit value= 繪出齒輪輪廓>
    </form>
    <br />
    <!-- 載入 brython.js -->
    <script type="text/javascript" src="/static/Brython3.1.1-20150328-091302/brython.js"></script>
    ...
    @cherrypy.expose
    # N 為齒數, M 為模數, P 為壓力角
    def spuraction_1(self, N=15, N1=24,N2=15,N3=24,M=10, P=20):
        outstring =''' 
    <!DOCTYPE html> 
    <html>
    <head>
